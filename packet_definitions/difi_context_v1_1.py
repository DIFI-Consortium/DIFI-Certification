...
def validate(packet):
    ...
    if packet.dataPacketFormat.item_packing_field_size < 3 or packet.dataPacketFormat.item_packing_field_size > 15: errors.append(f"Bit depth out of range")
    if packet.dataPacketFormat.data_item_size < 3 or packet.dataPacketFormat.data_item_size > 15: errors.append(f"Data item size out of range")
