...
This DIFI validation tool can be used as a stand-alone application that decodes and verifies whether packets in a packet stream are in compliance with DIFI, and can prepare and send DIFI compliant packets for testing purposes. The code consists of several Python modules, which you can import into your own scripts/applications. DIFI version 1.1 and above is supported; for 1.0 and legacy DIFI support please see [this version](https://github.com/DIFI-Consortium/DIFI-Certification/tree/last-version-with-legacy-difi-support). 
